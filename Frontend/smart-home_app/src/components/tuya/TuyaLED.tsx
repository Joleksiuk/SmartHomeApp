          ...
          <Grid container spacing={3}>
              ...
              <Grid justifyContent="center" container item>
                ...
                <Grid container justifyContent="center" rowSpacing={1} columnSpacing={{ xs: 1, sm: 2, md: 3 }}>
                  ...
                  <Grid container justifyContent="center" item xs={12}>
                    {!isSceneComponent &&  <Button variant="outlined" onClick = {deleteDeviceFromHouse} startIcon={<DeleteIcon />}>Delete device from house</Button>}
                    {isSceneComponent  &&  <Button variant="outlined"  onClick = {deleteDeviceFromScene} startIcon={<DeleteIcon /> }>Delete device from scene</Button>}
                  </Grid>
                </Grid>                                     
              </Grid>
          </Grid>  
          <DeleteModal message={deleteMessage} setDeleteConfirm={setConfirmDelete} open={openDeleteModal} setModalOpen = {setOpenDeleteModal}/>    
      </Box>
    </Grid>
    );
}